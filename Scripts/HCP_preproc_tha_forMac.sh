...
for s in 100307; do
	...
	for data in tfMRI_MOTOR_LR tfMRI_MOTOR_RL tfMRI_WM_LR tfMRI_WM_RL; do
		...
		-in_rois /home/despoB/kaihwang/Rest/ROIs/Thalamus_Morel_consolidated_mask_v3.nii.gz \
		-ts_out \
		-ts_label \
		-prefix /home/despoB/kaihwang/bin/HCP-processing/Data/TS/${s}_${data}_thalamus
